...
unsigned int nStakeMinAge = 14 * 24 * nOneHour; // 14 days as zero time weight
unsigned int nStakeMaxAge = 365 * 24 * nOneHour; // 365 days as full weight
...
const string strMessageMagic = "BonPeKaO Signed Message:\n";
...
void ThreadScriptCheck(void*) {
    ...
    RenameThread("BonPeKaO-scriptch");
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in BonPeKaO
...
bool CBlock::CheckBlock(bool fCheckPOW, bool fCheckMerkleRoot, bool fCheckSig) const
{
    ...
    if (fProofOfStake)
    {
        ...
        // BonPeKaO: check proof-of-stake block signature
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "BonPeKaO", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "BON Genesis Block";
        CTransaction txNew;
        txNew.nTime = 1464116583;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1464116587;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 947954; // !fTestNet ? 1575379 : 46534;
		

        block.print();

        //// debug print
        assert(block.hashMerkleRoot == uint256("0xd0e26cd55aeeb72f5a0a132f1e2dcbe7d83b1f2aad2a17778fa60cd2179c31da"));
...
unsigned char pchMessageStart[4] = { 0xb0, 0xf0, 0xe5, 0xe7 };
