...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString(QObject::tr("BonPeKaOs"));
    case mBTC: return QString(QObject::tr("Milli-BonPeKaOs (1 / 1,000)"));
    case uBTC: return QString(QObject::tr("Micro-BonPeKaOs (1 / 1,000,000)"));
    default: return QString("???");
    }
}
