BonPeKaO-qt: Qt4 GUI for BonPeKaO
===============================
...
Alternatively, install Qt Creator and open the `BonPeKaO-qt.pro` file.

An executable named `BonPeKaO-qt` will be built.
...
A warning for people using the *static binary* version of BonPeKaO on a Linux/UNIX-ish system (tl;dr: **Berkely DB databases are not forward compatible**).

The static binary version of BonPeKaO is linked against libdb5.3.
...
installed causes BonPeKaO-qt to crash intermittently.  The issue has been reported as `launchpad bug 857790`_, but
isn't yet fixed.
